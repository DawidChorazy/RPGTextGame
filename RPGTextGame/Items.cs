...
public class Items
{
    ...
    public static Dictionary<int, Items> items = new Dictionary<int, Items>
    {
        ...
        { 4, new Items(1, 0, 0,0,"Small Potion of Strength", "Usable") },
        {5, new Items(0,2,0,0,"Leather armor", "Chestplate")},
        {6, new Items(0,1,0,0,"Leather cap", "Helmet")},
        {7, new Items(0,1,0,0,"Leather leggings", "Legs")},
        {8, new Items(0,0,0,25,"Wooden Staff", "Weapon")},
        {9, new Items(0,0,0,0,"Cursed key", "Unique")}
    };
